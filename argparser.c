...
extern "C"
{
     ...
     */
    void init_parser(ArgumentParser_t *parser, const char *program, const char *usage, const char *description, const char *epilog);
     ...
     * print_help(parser, 1, 1, 1, 0);
     */
    void print_help(ArgumentParser_t *parser, int description, int usage, int epilog, int group);
...
ArgumentError::ArgumentError(const std::string &message, ArgumentError_t errorType)
{
    m_ErrType = errorType;
    m_Msg = message;
};
...
Argparser::Argparser(std::string program, std::string usage, std::string description, std::string epilog)
{
...
int Argparser::GetFlag(const char *name)
{
...
void Argparser::AddArg(char sym, const char *name, int required, int nargs, const char *default_value, const char *help)
{
    add_arg(&m_Parser, sym, name, required, nargs, default_value, help);
};

void Argparser::AddKwarg(char sym, const char *name, int required, const char *default_value, const char *help)
{
...
ArgumentError_t GetErrType(ArgumentError *error)
{
    return error->m_Type;
};
...
void Help(Argparser *parser, int description, int usage, int epilog, int group)
{
}
...
void AddArg(Argparser *parser, char sym, const char *name, int required, int nargs, const char *default_value, const char *help)
{
    add_arg(parser->m_Parser, sym, name, required, nargs, default_value, help);
}

void AddKwarg(Argparser *parser, char sym, const char *name, int required, const char *default_value, const char *help)
{
...
void freeArgumentParser(Argparser *parser)
{
    free_parser(parser->m_Parser);
};
