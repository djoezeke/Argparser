...
int main(int argc, char *argv[]) {
  // Initialize the parser with program details and add a help flag
  // automatically
  Argparser parser("my_program", "Usage: my_program [options]",
                   "This is a sample program.", "Epilog message");
